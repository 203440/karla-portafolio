        ...
        <div className="sobre-mi-contenido">
          <div className="perfil-bio">
            ...
            <div className="bio-texto">
              <p>
                Soy una Desarrolladora fullstack jr enfocada en crear y aprender nuevas cosas. Tengo conocimientos
                construyendo aplicaciones web con Javascript, React, Vue, Django solo por mencionar las más destacadas en
                mi perfil. Tengo la experiencia de trabajar en equipos para la colaboración de creación y despliegue de
                proyectos. Estoy abierto a nuevas oportunidades donde pueda seguir aprendiendo y aportar mis conocimientos
